...
- Harvest guides for crawling **datasets** from catalog APIs (`docs/harvest.md`): scientific IRs, open data portals, geoportals (CSW/STAC/ArcGIS), indicators/microdata, metadata catalogs (FDP/Fusion Registry), and aggregators/ML/`custom`. Agent checklist: `docs/agents/harvest.md`.
