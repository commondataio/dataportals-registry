...
- Update “Latest snapshot” dates and record counts in `README.md` and `docs/getting-started.md`.
...
```bash
git add CHANGELOG.md README.md docs/getting-started.md AGENTS.md .github/RELEASE_NOTES_v*.md
