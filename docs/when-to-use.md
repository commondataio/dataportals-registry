...
3. “Give me the API URL to harvest.”  
   Use this registry: read `endpoints[]` and `api_status`. Then harvest the remote catalog ([harvest.md](harvest.md)). Scientific IRs: [harvest-scientific.md](harvest-scientific.md). Geo: [harvest-geoportals.md](harvest-geoportals.md). Indicators: [harvest-indicators.md](harvest-indicators.md). Shared protocols: [harvest-protocols.md](harvest-protocols.md). Incremental: [harvest-incremental.md](harvest-incremental.md). Identifiers: [harvest-identifiers.md](harvest-identifiers.md). Output: [harvest-output.md](harvest-output.md).
