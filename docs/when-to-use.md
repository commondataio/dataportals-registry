...
3. “Give me the API URL to harvest.”  
   Use this registry: read `endpoints[]` and `api_status`. Then harvest the remote catalog ([harvest.md](harvest.md)). Scientific IRs: [harvest-scientific.md](harvest-scientific.md). Open data: [harvest-opendata.md](harvest-opendata.md). Geo: [harvest-geoportals.md](harvest-geoportals.md). Indicators: [harvest-indicators.md](harvest-indicators.md). Metadata: [harvest-metadata.md](harvest-metadata.md). Aggregators/ML/`custom`: [harvest-other.md](harvest-other.md). Shared protocols: [harvest-protocols.md](harvest-protocols.md). Incremental: [harvest-incremental.md](harvest-incremental.md). EO: [harvest-earthdata.md](harvest-earthdata.md). Biodiversity: [harvest-biodiversity.md](harvest-biodiversity.md). Viewers: [harvest-viewers.md](harvest-viewers.md). Identifiers: [harvest-identifiers.md](harvest-identifiers.md). Output: [harvest-output.md](harvest-output.md).
