...
GEONODE_URLMAP = [
    {'id' : 'geonode:layers', 'url' : '/api/layers/', 'expected_mime' : JSON_MIMETYPES, 'is_json' : True, 'version': ""},
    {'id' : 'geonode:datasets', 'url' : '/api/datasets/', 'expected_mime' : JSON_MIMETYPES, 'is_json' : True, 'version': ""},
    {'id' : 'geonode:documents', 'url' : '/api/documents/', 'expected_mime' : JSON_MIMETYPES, 'is_json' : True, 'version': ""},
    {'id' : 'dcatus11', 'url' : '/data.json', 'expected_mime' : JSON_MIMETYPES, 'is_json' : True, 'version': ""},
...
ALEPH_URLMAP = [
    ...
    {'id' : 'aleph:query', 'url' : '/api/1/query', 'accept' : 'application/json', 'expected_mime' : JSON_MIMETYPES, 'is_json' : True, 'version': '1.0'}
]
...
'ckan' : CKAN_URLMAP, 'geonetwork' : GEONETWORK_URLMAP, 'openwis' : GEONETWORK_URLMAP, 'pxweb' : PXWEB_URLMAP,
