...
Approximately **14,972** verified entity records (August 2026), plus scheduled/unverified entries in `data/scheduled/`. Export counts are listed in [README.md](README.md#data-exports).
