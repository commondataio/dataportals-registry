...
### Requirement: ID Host Correlation Check
**Reason**: Enforcing id/host correlation would break compatibility with historical catalog ids from past releases.
**Migration**: Do not emit `ID_HOST_MISMATCH`; keep existing ids stable.
