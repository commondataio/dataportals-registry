...
- `data/datasets/catalogs.jsonl` (+ `.zst`): 12,604 catalog records
- `data/datasets/software.jsonl` (+ `.zst`): 136 software/platform definitions
- `data/datasets/scheduled.jsonl` (+ `.zst`): 677 scheduled sources to crawl
- `data/datasets/full.jsonl` (+ `.zst`): 13,281 combined entities + scheduled records
